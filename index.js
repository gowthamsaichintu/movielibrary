                ...
                <div class="cards">
                    <div class="card" id=${movieID}>
                        ...
                        <div class="card-header">
                            ...
                            <img src="https://findicons.com/files/icons/1620/crystal_project/22/knewstuff.png" class="star-icon" />
                        ...
                        <div class="card-meta">
                            ...
                            <button class="card-btn card-watchlist watchlist-btn" id="${watchlistBtnKey}" onclick="addToWatchlist(${movieIDkey}, ${movieID}, ${watchlistBtnKey}, ${removeBtnKey})"><img src="https://img.icons8.com/material-sharp/2x/plus.png" class="card-watchlist-plus-icon" />&nbsp;Watchlist</button>

                            <button class="card-btn card-watchlist remove-watchlist-btn" id="${removeBtnKey}" onclick="removeFromWatchlist(${movieIDkey}, ${removeBtnKey}, ${watchlistBtnKey}, ${removeBtnKey})"><img src="https://img.icons8.com/fluency-systems-filled/2x/minus.png" alt="Remove film to watchlist" class="card-watchlist-plus-icon" />&nbsp;Remove</button>
                        </div>
